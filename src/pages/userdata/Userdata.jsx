...
const UserData = () => {
  ...
  useEffect(() => {
    const fetchFormData = async () => {
      try {
        const response = await axios.get(`https://172.31.41.116:5000/api/forms/${formId}`);
  ...
  const handleApprove = async () => {
    try {
      await axios.put(`https://172.31.41.116:5000/api/forms/approve/${formId}`);
  ...
  const submitRejectReason = async () => {
    try {
      await axios.put(`https://172.31.41.116:5000/api/forms/reject/${formId}`, { rejectReason });
    ...
    <div className={`user-data-container ${menuOpen ? 'menu-expanded' : ''}`}>
      ...
      <div className={`main-content ${menuOpen ? 'menu-expanded' : ''}`}>
        ...
        <div className="user-data">
          ...
          {formData.disabilities === 'yes' && (
            <>
              ...
              <p><strong>
                ...
                <a href={`https://172.31.41.116:5000/${formData.disabilityCertificate}`} target="_blank" rel="noopener noreferrer">
                  View Document
                </a>
              </p>
            </>
          ...
          <div className="row">
          <p><strong>Xth Marksheet: </strong><a href={`https://172.31.41.116:5000/${formData.xthMarksheet}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>XIIth Marksheet:</strong> <a href={`https://172.31.41.116:5000/${formData.xiithMarksheet}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>UG Certifiate: </strong><a href={`https://172.31.41.116:5000/${formData.ugCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>PG Certifiate: </strong><a href={`https://172.31.41.116:5000/${formData.pgCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Birth Certifiate:</strong> <a href={`https://172.31.41.116:5000/${formData.birthCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>Community Certifiate: </strong><a href={`https://172.31.41.116:5000/${formData.communityCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Aadhar Card: </strong><a href={`https://172.31.41.116:5000/${formData.aadharCard}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>ID Card: </strong> <a href={`https://172.31.41.116:5000/${formData.idCard}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Fee Receipt: </strong><a href={`https://172.31.41.116:5000/${formData.feeReceipt}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
