...
const UserData = () => {
  ...
  const handleApprove = async () => {
    try {
      await axios.put(`https://35.160.120.126:5000/api/forms/approve/${formId}`);
  ...
  const submitRejectReason = async () => {
    try {
      await axios.put(`https://35.160.120.126:5000/api/forms/reject/${formId}`, { rejectReason });
    ...
    <div className={`user-data-container ${menuOpen ? 'menu-expanded' : ''}`}>
      ...
      <div className={`main-content ${menuOpen ? 'menu-expanded' : ''}`}>
        ...
        <div className="user-data">
          ...
          <div className="row">
          <p><strong>Xth Marksheet: </strong><a href={`https://35.160.120.126:5000/${formData.xthMarksheet}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>XIIth Marksheet:</strong> <a href={`https://35.160.120.126:5000/${formData.xiithMarksheet}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>UG Certifiate: </strong><a href={`https://35.160.120.126:5000/${formData.ugCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>PG Certifiate: </strong><a href={`https://35.160.120.126:5000/${formData.pgCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Birth Certifiate:</strong> <a href={`https://35.160.120.126:5000/${formData.birthCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>Community Certifiate: </strong><a href={`https://35.160.120.126:5000/${formData.communityCertificate}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Aadhar Card: </strong><a href={`https://35.160.120.126:5000/${formData.aadharCard}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
          <p><strong>ID Card: </strong> <a href={`https://35.160.120.126:5000/${formData.idCard}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
            
          <div className="row">
          <p><strong>Fee Receipt: </strong><a href={`https://35.160.120.126:5000/${formData.feeReceipt}`} target="_blank" rel="noopener noreferrer">
            View Document</a></p>
            </div>
