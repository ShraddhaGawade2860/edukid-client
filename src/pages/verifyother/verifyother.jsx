...
const VerifyOther = () => {
  ...
  const handleApprove = async () => {
    try {
      await axios.put(`https://172.31.41.116:5000/api/forms/otherstate/${formId}/approve`);
      alert('Form approved');
  ...
  const handleReject = async () => {
    try {
      await axios.put(`https://172.31.41.116:5000/api/forms/otherstate/${formId}/reject`, { rejectReason });
      alert('Form rejected');
      ...
      <div className={`main-content ${menuOpen ? 'menu-expanded' : ''}`}>
        ...
        {form ? (
          <div className="form-details">
            ...
            {form.disabilities === 'yes' && (
              <>
                ...
                <p><strong>
                  ...
                  <a href={`https://172.31.41.116:5000/${form.disabilityCertificate}`} target="_blank" rel="noopener noreferrer">
                    View Document
                  </a>
                </p>
            ...
            <div className="row">
            <p><strong>Xth Marksheet:</strong> <a href={`https://172.31.41.116:5000/${form.xthMarksheet}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p><strong>XIIth Marksheet: </strong><a href={`https://172.31.41.116:5000/${form.xiithMarksheet}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
              </div>
              <div className="row">
            <p><strong>UG Certificate: </strong><a href={`https://172.31.41.116:5000/${form.ugCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p><strong>PG Certificate: </strong><a href={`https://172.31.41.116:5000/${form.pgCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
              </div>
              <div className="row">
            <p><strong>Birth Certificate: </strong><a href={`https://172.31.41.116:5000/${form.birthCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p><strong>Community Certificate: </strong><a href={`https://172.31.41.116:5000/${form.communityCertificate}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
              </div>
              <div className="row">
            <p><strong>Aadhar Card: </strong><a href={`https://172.31.41.116:5000/${form.aadharCard}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
            <p><strong>ID Card: </strong><a href={`https://172.31.41.116:5000/${form.idCard}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
              </div>
              <div className="row">
            <p><strong>Fee Receipt: </strong><a href={`https://172.31.41.116:5000/${form.feeReceipt}`} target="_blank" rel="noopener noreferrer">
              View Document</a></p>
              </div>
