...
const EditUser = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setImagePreview(user.profileImage ? `https://shradha.onrender.com/uploads/${user.profileImage}` : '');
    }
  }, [user]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://shradha.onrender.com/api/users/${user.id}`, formDataToSend, {
        headers: {
