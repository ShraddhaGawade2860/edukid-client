...
const InstituteHome = () => {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        const response = await axios.get(`https://172.31.41.116:5000/api/institute/${encodeURIComponent(instituteName)}/counts`);
  ...
  useEffect(() => {
    const fetchPendingForms = async () => {
      try {
        const response = await axios.get(`https://172.31.41.116:5000/api/forms/institute/${encodeURIComponent(instituteName)}`);
  ...
  useEffect(() => {
    const fetchVerificationDetails = async () => {
      try {
        const response = await axios.get(`https://172.31.41.116:5000/api/institute/${encodeURIComponent(instituteName)}/verification-details`);
  ...
  useEffect(() => {
    const fetchScholarshipCount = async () => {
      try {
        const response = await axios.get('https://172.31.41.116:5000/api/scholarshipcount/count');
