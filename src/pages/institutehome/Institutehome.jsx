...
const InstituteHome = () => {
  ...
  useEffect(() => {
    const fetchCounts = async () => {
      try {
        const response = await axios.get(`http://3.110.2.125:5000/api/institute/${encodeURIComponent(instituteName)}/counts`);
  ...
  useEffect(() => {
    const fetchPendingForms = async () => {
      try {
        const response = await axios.get(`http://3.110.2.125:5000/api/forms/institute/${encodeURIComponent(instituteName)}`);
  ...
  useEffect(() => {
    const fetchVerificationDetails = async () => {
      try {
        const response = await axios.get(`http://3.110.2.125:5000/api/institute/${encodeURIComponent(instituteName)}/verification-details`);
  ...
  useEffect(() => {
    const fetchScholarshipCount = async () => {
      try {
        const response = await axios.get('http://3.110.2.125:5000/api/scholarshipcount/count');
